...
LOCAL_PROJECTION = "EPSG:32636"  # UTM projection for Egypt

T_PERC = ['75', '95']  # Temperature percentiles
...
for _, crop_row in CROPPING_CAL.iterrows():
    ...
    for t_idx, t_perc in enumerate(T_PERC + [None]):
        if t_perc is None:
            ...
            per_t = f"Tmax_P{t_perc}"

        print(f"    Processing {crop} for {warm} conditions...")
